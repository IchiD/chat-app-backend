...
CREATE TABLE `chat_rooms` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type` enum('group_chat','member_chat','friend_chat','support_chat') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `chat_rooms_deleted_by_foreign` (`deleted_by`),
  CONSTRAINT `chat_rooms_deleted_by_foreign` FOREIGN KEY (`deleted_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_02_03_080318_create_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_02_08_153206_create_password_resets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_05_12_141946_create_friendships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_05_21_181316_create_push_subscriptions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_05_30_100000_create_sessions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2025_06_03_100003_add_soft_delete_columns_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2025_06_03_100004_add_soft_delete_to_friendships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2025_06_03_100005_add_google_auth_columns_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2025_06_03_100006_add_verification_columns_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2025_06_03_100007_add_unique_friend_id_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2025_06_03_100008_add_email_change_fields_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2025_06_03_100012_create_operation_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2025_06_07_154244_create_external_api_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2025_06_08_000000_add_usage_columns_to_external_api_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2025_06_09_171459_create_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2025_06_09_171515_create_chat_rooms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2025_06_09_171520_create_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2025_06_09_171525_add_admin_delete_columns_to_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2025_06_09_171530_add_admin_sender_to_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2025_06_09_171535_make_sender_id_nullable_in_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2025_06_09_190403_modify_chat_rooms_table_allow_null_group_id',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2025_06_09_191034_add_friend_chat_type_to_chat_rooms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2025_06_09_231121_add_support_chat_to_chat_rooms_type_enum',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2025_06_10_101952_add_soft_delete_to_chat_rooms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2025_06_10_124922_add_support_chat_type_to_chat_rooms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2025_07_01_000003_create_subscriptions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2025_07_01_000005_add_subscription_fields_to_users_table',1);
